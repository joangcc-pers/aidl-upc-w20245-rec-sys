    ...
    for task in provided_order:
        ...
        if task == "preprocess":
            ...
            for weight_decay, dropout_rate, learning_rate in param_combinations:
                ...
                # Train model
                train_model(args.model, model_params, output_folder_artifacts, top_k=experiment_config["evaluation"]["top_k"], experiment_hyp_combinat_name=experiment_hyp_combinat_name)
