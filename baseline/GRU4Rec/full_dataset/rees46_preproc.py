...
def main(path: str):
    ...
    print("Loading 2019-Dec.csv")
    data3 = pd.read_csv(
        os.path.join(path, "2019-Dec.csv"),
        sep=",",
        usecols=["event_time", "event_type", "product_id", "user_id"],
        dtype={
            "event_type": "category",
    ...
    print("Loading 2020-Jan.csv")
    data4 = pd.read_csv(
        os.path.join(path, "2020-Jan.csv"),
        sep=",",
        usecols=["event_time", "event_type", "product_id", "user_id"],
        dtype={
            "event_type": "category",
    ...
    print("Loading 2020-Feb.csv")
    data5 = pd.read_csv(
        os.path.join(path, "2020-Feb.csv"),
        sep=",",
        usecols=["event_time", "event_type", "product_id", "user_id"],
        dtype={
            "event_type": "category",
    ...
    print("Loading 2020-Mar.csv")
    data6 = pd.read_csv(
        os.path.join(path, "2020-Mar.csv"),
        sep=",",
        usecols=["event_time", "event_type", "product_id", "user_id"],
        dtype={
            "event_type": "category",
    ...
    print("Loading 2020-Apr.csv")
    data7 = pd.read_csv(
        os.path.join(path, "2020-Apr.csv"),
        sep=",",
        usecols=["event_time", "event_type", "product_id", "user_id"],
        dtype={
            "event_type": "category",
    ...
    data = pd.concat([data, data2, data3, data4, data5, data6, data7])
